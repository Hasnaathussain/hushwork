...
export function SiteHeader() {
  ...
  const nav = [{ href: "/shop", label: "Shop" }, { href: "/collections/focus", label: "Collections" }, { href: "/about", label: "About" }];
  return (
    <header className="site-header site-shell">
      <Link href="/" className="wordmark" onClick={() => setMenuOpen(false)} aria-label="HUSHWORK home"><span className="wordmark-mark">H</span><span>HUSHWORK</span></Link>
      ...
      <div className="site-header__actions">
        <Link className="header-icon" href="/shop" aria-label="Search products"><Search size={17} /></Link>
        <Link className="header-account" href="/account">Account</Link>
